...
namespace Gameplay.GameplayObjects.Character.Customisation.Data
{
    ...
    public class BuildData
    {
        ...
        public CoreSystemData GetCoreSystemData() => GetFrameData().CoreSystem;
        public ModuleData GetSlottableData(AttachmentSlotIndex slotIndex) => slotIndex.GetSlotIndex() < ActiveSlottableIndicies.Length ? CustomisationOptionsDatabase.AllOptionsDatabase.GetModuleData(ActiveSlottableIndicies[slotIndex.GetSlotIndex()]) : null;
        public int GetSlottableDataIndex(AttachmentSlotIndex slotIndex) => slotIndex.GetSlotIndex() < ActiveSlottableIndicies.Length ? ActiveSlottableIndicies[slotIndex.GetSlotIndex()] : throw new System.ArgumentOutOfRangeException("");
    }
}